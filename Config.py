...
class Config:
    def __init__(self, string):
        ...
        if string == "1":
            ...
            self.other_computation = binomial_trees_BS(self.xi, r, mu(1), sigma(1), self.T, self.N * 10, K)
            ...
            print(binomial_trees(self.xi, r, sigma(1), self.T, self.N * 10, K))
            print(binomial_trees_BS(self.xi, r, mu(1), sigma(1), self.T, self.N * 10 / self.T, K))
